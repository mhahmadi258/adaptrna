...
@register_task("regression_random")
class RegressionRandomModule(BaseDownstreamModule):
    """regression target from a flat sequence/label table"""

    TASK_NAME = "regression_random"
    ...
    def build_datamodule(cfg):
        from adaptrna_custom.tasks.regression_random.datamodule import CsvDataModule
