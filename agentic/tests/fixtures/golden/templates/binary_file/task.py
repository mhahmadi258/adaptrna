...
@register_task("binary_file")
class BinaryFileModule(BaseDownstreamModule):
    """binary target from a flat sequence/label table
    ...
    def build_datamodule(cfg):
        from adaptrna_custom.tasks.binary_file.datamodule import CsvDataModule
