...
@register_task("binary_random")
class BinaryRandomModule(BaseDownstreamModule):
    """binary target from a flat sequence/label table
    ...
    def build_datamodule(cfg):
        from adaptrna_custom.tasks.binary_random.datamodule import CsvDataModule
